...
const CARDS = [
  ...
  {
    eyebrow: "FOR THE AGENT",
    headlinePre: "Between closings,",
    headlineItalic: "real money",
    headlinePost: " still moves.",
    subhead: "Solar, $0-down purchase, Local Spotlight, Income Snowball. Residuals the listing app won't show you.",
    cta: "Open the agent path",
    href: "https://itsownlymoney.vercel.app/?source=hub&audience=agent#agents",
    image: "/hero/agent.jpg",
    loop: "/loops/agent.mp4",
    audience: "agent" as const,
  },
  {
    eyebrow: "FOR THE INDIVIDUAL",
    headlinePre: "Real wealth",
    headlineItalic: "isn't",
    headlinePost: " a calculator.",
    subhead: "Debt acceleration, tax recovery, gold + bonds, the 5-Year Wealth Plan.",
    cta: "Begin WealthPath",
    href: "https://itsownlymoney.vercel.app/?source=hub&audience=individual",
