    ...
    <section style={{ background: "var(--paper-warm)", padding: "100px 0 90px" }}>
      <div className="container" style={{ maxWidth: 760, textAlign: "center" }}>
        <p style={{
          ...
          &ldquo;Ownly ONCE is the umbrella over two breakthroughs — one for the individual, one for the household. Both give you the access and ability to take control of your financial future at the pace that is best for you. We don&rsquo;t sell. We <em style={{ color: "var(--gold-dark)" }}>find</em>.&rdquo;
        </p>
