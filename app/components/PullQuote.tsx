    ...
    <section style={{ background: "var(--paper-warm)", padding: "100px 0 90px" }}>
      <div className="container" style={{ maxWidth: 760, textAlign: "center" }}>
        <p style={{
          ...
          &ldquo;Ownly ONCE is the umbrella over a small family of products that put the credit, capital, AI, and education an ordinary owner is already missing back under their direct control. We don&rsquo;t sell. We <em style={{ color: "var(--gold)" }}>find</em>.&rdquo;
        </p>
